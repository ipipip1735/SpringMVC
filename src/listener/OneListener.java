package listener; /**
 * Created by Administrator on 2019/8/30 10:27.
 */
...
public class OneListener implements ServletContextListener,
    ...
    public void sessionCreated(HttpSessionEvent se) {
        /* Session is created. */
        System.out.println("~~" + getClass().getSimpleName() + ".sessionCreated~~");
    }

    public void sessionDestroyed(HttpSessionEvent se) {
        /* Session is destroyed. */
        System.out.println("~~" + getClass().getSimpleName() + ".sessionDestroyed~~");
    }
